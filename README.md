...
- 💻 **Tech:** Estudando Python e SQL para análise de dados e eficiência operacional (Queries, Filtros e Relatórios).
- ⚙️ **Foco:** Auxiliar de Logística | Assistente Administrativo | Suporte TI.

---
*Buscando oportunidades para aplicar lógica de programação na resolução de problemas administrativos.*
